...
public class AzureBlobRequestSignerTest extends BaseRestAnnotationProcessingTest<AzureBlobClient> {
   ...
   public void testSignGetBlob() throws ArrayIndexOutOfBoundsException, SecurityException, IllegalArgumentException,
      ...
      assertRequestLineEquals(request, "GET https://identity.blob.core.windows.net/container/name?sv=2019-12-12&se=2008-06-05T16%3A53%3A19Z&sr=b&sp=r&sig=jW7XnAX7if2JE0b0lm%2BhTQ/frY%2BjPbRgdU%2BKABLKFKM%3D HTTP/1.1");
   ...
   public void testSignRemoveBlob() throws ArrayIndexOutOfBoundsException, SecurityException, IllegalArgumentException,
      ...
      assertRequestLineEquals(request, "DELETE https://identity.blob.core.windows.net/container/name?sv=2019-12-12&se=2008-06-05T16%3A53%3A19Z&sr=b&sp=d&sig=QklVzkO6pCRhTk6rwllVR51oLSaN1bOYgmbUs3JYLvY%3D HTTP/1.1");
      assertNonPayloadHeadersEqual(request, "Date: Thu, 05 Jun 2008 16:38:19 GMT\n");
      assertPayloadEquals(request, null, null, false);
   ...
   public void testSignPutBlob() throws ArrayIndexOutOfBoundsException, SecurityException, IllegalArgumentException,
      ...
      assertRequestLineEquals(request, "PUT https://identity.blob.core.windows.net/container/name?sv=2019-12-12&se=2008-06-05T16%3A53%3A19Z&sr=b&sp=w&sig=oa6aWZy97AgzN0qrLJRn9/BESjxF9P4EmhnzDvaart0%3D HTTP/1.1");
